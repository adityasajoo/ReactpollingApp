...
const formatData = (yesData,noData)=>{
    yesData.forEach(data => data.casted_at = data.casted_at.slice(0,10));// { [ count:10, casted_at:2021-10-01 ,..]}
    noData.forEach(data => data.casted_at = data.casted_at.slice(0,10));
